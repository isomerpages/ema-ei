...
<div class="program-tbl-container">
  <table>
	  ...
	  <tr>
	    <td>2:30pm</td>
	    <td colspan="2"><p class="programme-topic">Research Collaboration Agreement Signing on Green Compass Initiative by A&ast;STAR, JTC and TÜV SÜD<br/><i>Find out more about the Green Compass Initiative [here](/files/showcase/green_compass_initiative.pdf)</i></p></td>
	  </tr>
	  <tr>
	    <td>3:00pm</td>
	    <td colspan="2">
